...
const KEYCLOAK_CONFIG = {
  ...
  clientId: import.meta.env.VITE_KEYCLOAK_CLIENT_ID || 'munistream-admin',
};
...
/**
 * Keycloak Service - Handles all Keycloak authentication operations
  ...
  private async doInit(): Promise<boolean> {
    try {
      ...
      if (isCallback) {
        ...
        // Don't use check-sso as it can cause loops
