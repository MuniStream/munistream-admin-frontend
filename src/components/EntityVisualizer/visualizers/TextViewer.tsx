      ...
      <Paper variant="outlined" sx={{ p: 2, mt: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
          <Typography variant="subtitle2" color="text.secondary">
            {t('entViz.structuredData')}
          </Typography>
          <Box>
            <IconButton size="small" onClick={handleCopy} title={copied ? t('entViz.copied') : t('entViz.copy')}>
              <ContentCopy fontSize="small" />
            </IconButton>
            <IconButton size="small" onClick={handleDownload} title={t('entViz.downloadJson')}>
